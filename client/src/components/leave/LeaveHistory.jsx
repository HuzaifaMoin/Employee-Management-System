                                    ...
                                    <tr key={leave._id || leave.id}>
                                        ...
                                        <td >
                                            <span className={`badge ${leave.status ===
                                                "APPROVED" ? "badge-success" : leave.status
                                                    === "REJECTED" ? "badge-warning" : "badge-danger"}`}>
                                                {leave.status}
                                            </span>
                                        </td>
                                        {isAdmin && (
                                                    ...
                                                    <div className='flex justify-center gap-2'>
                                                        <button disabled={!!processing}
                                                            ...
                                                            {processing === (leave._id || leave.id) ? <Loader2
                                                                className='w-4 h-4 animate-spin' /> : <Check className='w-4 h-4' />}
                                                        </button>
