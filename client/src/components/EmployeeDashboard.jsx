            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
{
    cards.map((card, index) => (
        ...
        justify-between'>
            <div> <div className='absolute left-0 top-0 bottom-0 w-1
           ...
           <div className='flex flex-col sm:flex-row gap-3'>
            <Link to='/attendance' className='btn-primary text text-center
            inline-flex items-center justify-center gap-2'>
                Mark Attendance <ArrowRightIcon className='w-4 h-4' />
            
            </Link>
             <Link to='/leave' className='btn-secondary text-center inline-flex gap-1'>
                Apply for Leave <ArrowRightIcon className='w-4 h-5'/>
            </Link>
           </div>
        </div>
    )
