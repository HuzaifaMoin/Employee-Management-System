...
const Employee = () => {
  ...
  return (
    ...
    pl-10" onChange={(e) => setSearch(e.target.value)} value=
        ...
        <select value={selectDept} onChange={(e) => setSelectDept(e.
    ...
    z-50 flex items-start justify-center p-4 overflow-y-auto" onClick={() => setShowCreateModal(false)}>

          <div className="fixed inset-0 relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" onClick={(e) => e.stopPropagation()}>
        ...
        max-w-3xl my-8 animate-fade-in' onClick={(e) => e.stopPropagation()}>
            <div className='flex items-center justify-between p-6 pb-0'>
              <div>
                ...
                <p className='text-sm text-slate-500 mt-0.5'> Edit your employee profile</p>
              </div>
